				...
				<div class="collapse navbar-collapse" id="menuNavegacion">
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							<a href="index.php" class="nav-link dropdown-toggle" id="navbarDropdown" data-toggle="dropdown">
								Productos
							</a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a href="mazatravel/computadoras.com" class="dropdown-item">Computadoras</a>
								<a href="mazatravel/laptops.com" class="dropdown-item">Laptops</a>
								<a href="mazatravel/smartphones.com" class="dropdown-item">Smartphones</a>
								<a href="mazatravel/drones.com" class="dropdown-item">Drones</a>
								<a href="mazatravel/accesorios.com" class="dropdown-item">Accesorios</a>
							</div>
						</li>
						<li class="nav-item">
			...
			<div class="col-12 col-sm-6 col-lg-4 mb-4">
				<div class="card">
					...
					<div class="card-body">
						...
						<a href="mazatravel/detalles" class="btn btn-sm btn-secondary">Detalles</a>
						<a href="mazatravel/comprar" class="btn btn-sm btn-primary">Comprar</a>
					</div>
				</div>
			</div>
